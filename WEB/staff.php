...
<body>
  ...
  <div id="contentcontainer">
    <div id="contentarea">
      <div id="contentbanner"><h1>EASIH Staff Members</h1>
      </div>
      <table border="0" WIDTH="100%">
	<TR><TD WIDTH="25%"</TD><TD WIDTH="75%"</TD></tr>
				    <tr><td><b>John Todd</b></td><td><b>Director</b></td></tr>
	  <td></td>
	  <td>John Todd is Professor of Medical Genetics at Cambridge University, UK, and Director of the <a href="http://www-gene.cimr.cam.ac.uk/todd/">Juvenile Diabetes Research Foundation/Wellcome Trust Diabetes and Inflammation Laboratory</a> in the Cambridge Institute for Medical Research. Todd's research centres on the molecular genetic and mechanistic basis of the autoimmune, inflammatory disease, type 1 diabetes.</td>
	</tr>
	<p>
	<tr><td><b>Anthony Rogers</b></td><td><b>Head of Facility</b></td></tr>
	<tr><td></td><td>Anthony gained his PhD at the University of Leicester under Prof. Bambos Kyriacou.  After a brief sojourn in the video game development industry Anthony joined the Sanger Institute working for Richard Durbin on the WormBase project.  After 3 years he took over as the project manager. Whilst at the Sanger he also participated in the Gorilla genome sequencing project.</td></tr>
<tr></tr>

	<center><tr><TH COLSPAN=2><h2>Sequencing Team</h2></th></tr></CENTER>
<tr></tr>
	<tr><td><b>Ilenia Simeoni</b></td><td><b>Head of Laboratory</b></td></tr>
...
<tr></tr>
-->
	<tr><td><b>Louise Godfrey</b></td><td><b>Research Assistant</b></td></tr>
<!--	<tr><td></td><td>Louise gained a 2:1 BSc (Hons) Forensic Science from the University of Central Lancashire. Following this she spent just under two years as a microbiologist. In March 2008 she moved to Source Bioscience, first working in Contract Research. After 10 months Louise joined the then new Next Generation Sequencing Team of which she spent 2 years 10 months helping to establish the lab as well as maintain the workflow.</td></tr>
-->
	<tr><td></td><td>Louise gained her degree in Forensic Science, and then spent a couple of years in Microbiology. She then moved into Contract Research doing WGA, RNA, taqman, genotyping and sanger sequencing before going into Next Generation Sequencing. She has now spent 5 years in the field spread between commercial and academia. With experience from helping to set up and run lab work, incorporating a quality management systems and GLP.</td></tr>
<tr></tr>
	
	<tr><td><b>Claire Haskins</b></td><td><b>Research Assistant</b></td></tr>
	<tr><td></td><td>Claire carried out her BSc in biology at York and MSc at Hull where she studied the evolution of the cichlid species flock. She then spent several years working on short term research projects before joining the University of York Technology Facility running the capillary DNA sequencing service and protein ID services. She then joined the Sanger Institute working on the mouse genotyping project before moving to EASIH.</td></tr>
<tr></tr>

	<tr><td><b>Emma Eastwell</b></td><td><b>Senior Lab Technician</b></td></tr>
	<tr><td></td><td>Emma has gained more than 26 years experience in many scientific practices, whilst working at a Contract Research Organisation. In more recent years, Emma has been involved in quantitative whole-body autoradiography (QWBA) studies as a Senior Study Scientist before joining EASIH in August 2011. She is currently studying towards her BSc (Hons) Life Sciences with an Open University and intends to graduate next year.</td></tr>
<tr></tr>

	<tr><td><b>Anna Livings</b></td><td><b>Senior Lab Technician</b></td></tr>
...
<tr></tr>
	<center><tr><TH COLSPAN=2><h2>Support Team</h2></th></tr></CENTER>
  <tr><td><b>Selina Day</b></td><td><b>Business Manager</td></tr>
