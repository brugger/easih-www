...
<?php
		if(isset($_POST["alldone"]))
		{
			...
			{
?>
				<h4><font color="red">Sorry! You got the 'sortfunc' wrong. We suspect the enqury is a spam generated by a robot, hence discarding it. Please fill the sortfunc, if this is a genuine enqury.</font></h4>
<?php
			}
			else
			{	
